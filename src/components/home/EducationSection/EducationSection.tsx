...
export default function EducationSection() {
  return (
    <div
      className="flex justify-center w-full py-12 bg-background mx-auto  xl:max-w-[1300px] px-6"
      id="education"
    >
      <div className="grid md:grid-cols-4 gap-8 w-full">
        ...
        <div className="col-span-2">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gradient-to-br  rounded-3xl shadow-xl border border-[#334155] p-8"
          >
